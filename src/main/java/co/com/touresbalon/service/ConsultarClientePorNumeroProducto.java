...
/**
 * <p>Clase Java para consultarClientePorNumeroProducto complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarClientePorNumeroProducto"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarClientePorNumeroProducto", propOrder = {
    "filtro"
})
public class ConsultarClientePorNumeroProducto {
