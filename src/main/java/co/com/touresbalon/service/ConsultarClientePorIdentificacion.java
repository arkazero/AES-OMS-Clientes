...
/**
 * <p>Clase Java para consultarClientePorIdentificacion complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarClientePorIdentificacion"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarClientePorIdentificacion", propOrder = {
    "filtro"
})
